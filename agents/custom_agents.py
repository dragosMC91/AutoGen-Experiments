...
claude_35_sonnet = get_config(["anthropic/claude-3.5-sonnet"])
...
def get_agents() -> Dict:
    ...
    return {
        ...
        "critic": autogen.AssistantAgent(
            name="critic",
            llm_config=get_llm_config(claude_35_sonnet, {"temperature": 0.1}),
            system_message="""
            Critic AI LLM.
        ...
        "anthropic_coder": autogen.AssistantAgent(
            ...
            llm_config=get_llm_config(claude_35_sonnet),
            system_message=coder_system_message,
        ),
        ...
        "image_generator": autogen.ConversableAgent(
            ...
            llm_config=get_llm_config(dalle_config, {"temperature": 0.7}),
            system_message="""
            A creative agent.
            """,
